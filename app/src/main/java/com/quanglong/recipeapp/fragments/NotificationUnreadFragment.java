...
public class NotificationUnreadFragment extends Fragment {
     ...
     * @return A new instance of fragment NotificationUnreadFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static NotificationUnreadFragment newInstance(String param1, String param2) {
        NotificationUnreadFragment fragment = new NotificationUnreadFragment();
...
//        btn.setOnClickListener(this);
    ...
    private void getNotificationAll(){
        notificationViewModel.getNotificationWithParam(id,0,1,10).observe(getActivity(), new Observer<NotificationResponse>() {
            @Override
    ...
    private void doInitialization(View view) {
        ...
        recyclerView = view.findViewById(R.id.notification_unread_rv);
