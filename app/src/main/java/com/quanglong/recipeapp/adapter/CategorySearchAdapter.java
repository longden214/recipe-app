...
public class CategorySearchAdapter extends RecyclerView.Adapter<CategorySearchAdapter.CategoryViewHolder> {

    Context context;
    List<Category> categoryList;
    CategoryListener categoryListener;

    public CategorySearchAdapter(Context context, List<Category> categoryList,CategoryListener categoryListener) {
